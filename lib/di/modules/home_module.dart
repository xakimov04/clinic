...
import 'package:clinic/features/home/data/clinics/repositories/clinics_repository_impl.dart';
import 'package:clinic/features/home/domain/clinics/repositories/clinics_repository.dart';
import 'package:clinic/features/home/domain/clinics/usecase/get_clinics_usecase.dart';
...
Future<void> registerHomeModule() async {
  ...
  sl.registerFactory(() => IllnessBloc(sl<GetIllnessUsecase>()));
